...
| Trying niri as a third session | system | Installed `niri` + `xwayland-satellite`; starter `config.kdl` ports the Hyprland/Mango binds, input, monitors, look and autostart. Watch for the NVIDIA busy-loop that broke Mango | [system/niri-trial.md](system/niri-trial.md) |
