...
| Tried niri, went back to Hyprland | system | niri worked on this hardware (both monitors, no NVIDIA busy-loop) but lacks the special workspace, master layout, Lua hooks and submaps this setup relies on; uninstalled same day | [system/niri-tried-and-reverted.md](system/niri-tried-and-reverted.md) |
